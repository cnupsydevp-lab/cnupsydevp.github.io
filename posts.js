  ...
  notices: [
    {
      ...
      body: `<p class="post-attach"><a href="notice-files/2026-08-11_grad-recruit.pdf" target="_blank" rel="noopener">🔗 모집 안내 포스터</a></p>
<p>충남대학교 심리학과 디지털 심리케어 연구실에서 석사과정 진학을 희망하는 학부연구생을 모집합니다!</p>
<p>아이트래킹·rPPG 등 멀티모달 측정으로 외로움이 사회적 자극의 주의처리와 인지부하에 미치는 영향을 살펴보는 연구, 그리고 디지털 헬스케어 기업과의 산학협력 rPPG·심리 평가 시스템 개발 프로젝트에 함께 참여할 수 있습니다.  데이터 분석 도구(Python, R, SPSS)와 통계·머신러닝 기반 분석 역량도 함께 익힐 수 있습니다.</p>
<p>심리학 전공이 아니어도 괜찮습니다!  대학원에 관심 있는 4학년 이상이면 전공 불문 지원할 수 있습니다. 수시 모집이며, 자세한 내용은 위 포스터를 확인해 주세요.</p>
<p>지원·문의: 간단한 자기소개서와 관심 분야를 이메일로 보내 주시면 개별 면담 일정을 조율합니다.<br>
LIFE:ON LAB 지도교수 노수림: <a href="mailto:srnoh@cnu.ac.kr">srnoh@cnu.ac.kr</a> (이메일 제목: <strong>[대학원 석사과정 문의] 학번_이름_전공</strong>)</p>`
    }
  ],

  /* ── 연구참여 ─────────────────────────────────────────────
     [2026-09-12] 여기에 있던 한 건을 아래로 내렸다. 세 가지가 겹쳐 있었다:
       · 본문이 통째로 "내용을 준비 중입니다." — 눌러도 대상·기간·연락처가 없다
       · 배지는 '모집' 인데 날짜가 넉 달 전(2026-05-15)
       · 주제(영유아 언어 발달)가 이 연구실이 소개하는 분야(중년·노년 발달·노화)와
         다르다 — 만들 때 넣어 둔 예시 글로 보인다
     그런데 script.js 가 이 배열의 최신 날짜를 읽어 상단 메뉴에 빨간 알림 점을
     띄운다. 즉 '새 글이 있다'고 사람을 불러 놓고 빈 글을 보여 주고 있었다.
     배열을 비우면 _latestDate() 가 null 을 돌려주어 점도 함께 사라지고,
     participation.html 은 안내 문단(현재 모집 중인 연구가 없습니다 …)을 보여 준다.
     실제 모집이 시작되면 아래 형식을 그대로 채워 배열에 다시 넣으면 된다.

       { id: 1, date: 'YYYY-MM-DD', badge: 'badge-navy', badgeText: '모집',
         title: '[연구 참여자 모집] …',
         body: `<p>대상 · 참여 방법 · 소요 시간 · 사례 · 문의처를 적는다</p>` }
     ──────────────────────────────────────────────────────── */
  participation: [],
  ...
  activities: [
    ...
    { type: 'publication', year: '2022', date: '2022-02-01', badge: 'badge-gold', badgeText: 'SSCI',
      title: 'Eye Movement Patterns Reflecting Cybersickness: Evidence from Different Experience Modes of a Virtual Reality Game',
      authors: 'Yunju Nam, Upyong Hong, Hyenyeong Chung, Soo Rim Noh',
      journal: 'Cyberpsychology, Behavior, and Social Networking, 25(2), 135–139',
      url: 'https://journals.sagepub.com/doi/abs/10.1089/cyber.2021.0167' },
    ...
    { type: 'publication', year: '2019', date: '2019-10-01', badge: 'badge-gold', badgeText: 'KCI',
      ...
      authors: 'Meesook Kim, Soo Rim Noh',
    ...
    { type: 'publication', year: '2009', date: '2009-01-01', badge: 'badge-gold', badgeText: 'SSCI',
      title: 'Predispositional Engagement, Activity Engagement, and Cognition among Older Adults',
      authors: 'Jeanine M. Parisi, Elizabeth A. L. Stine-Morrow, Soo Rim Noh, Daniel G. Morrow',
    ...
    { type: 'publication', year: '2024', date: '2024-12-31', badge: 'badge-gold', badgeText: 'KCI',
      ...
      authors: 'Seung Chul Lee, Sungkun Cho, Yerin Shim, So Yeong Yoon, Soo Rim Noh',
    ...
    { type: 'publication', year: '2023', date: '2023-09-01', badge: 'badge-gold', badgeText: 'KCI',
      ...
      authors: 'Sun Hyun Moon, Jinsup Eom, Wonil Choi, Allyson Brothers, Soo Rim Noh',
    ...
    { type: 'publication', year: '2018', date: '2018-01-01', badge: 'badge-gold', badgeText: 'KCI',
      ...
      authors: 'Hongoak Yun, Sun Hyun Moon, Soo Rim Noh',
    ...
    { type: 'publication', year: '2014', date: '2014-12-01', badge: 'badge-gold', badgeText: 'SSCI',
      ...
      journal: 'Psychology and Aging, 29(4), 891–906',
    ...
    { type: 'publication', year: '2011', date: '2011-08-01', badge: 'badge-gold', badgeText: 'SSCI',
      title: 'Does Looking at the Positive Mean Feeling Good? Age and Individual Differences Matter',
      authors: 'Derek M. Isaacowitz, Soo Rim Noh',
      journal: 'Social and Personality Psychology Compass, 5(8), 505–517',
